...
sub initPlugin {
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return Foswiki::Plugins::DBCachePlugin::Core::handleNeighbours( 1,
                @_ );
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return Foswiki::Plugins::DBCachePlugin::Core::handleNeighbours( 0,
                @_ );
        }
    );
...
# after "createweb" has finished.
    ...
    initCore();
    return Foswiki::Plugins::DBCachePlugin::Core::afterSaveHandler( $_[2],
        $_[1] );
}
...
sub afterAttachmentSaveHandler {
    ...
    return
      if $Foswiki::Plugins::VERSION >= 2.1
          || $Foswiki::cfg{DBCachePlugin}
          {UseUploadHandler}; # set this to true if you backported the afterUploadHandler
...
sub afterUploadHandler {
    ...
    my $topic = $meta->topic;
    initCore();
    return Foswiki::Plugins::DBCachePlugin::Core::afterSaveHandler( $web,
        $topic );
}
...
sub afterRenameHandler {
    ...
    initCore();
    return Foswiki::Plugins::DBCachePlugin::Core::afterSaveHandler( $web,
        $topic, $newWeb, $newTopic, $attachment, $newAttachment );
}
